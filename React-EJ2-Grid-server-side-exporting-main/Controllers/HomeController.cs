...
namespace ReactGrid.Controllers
{
    ...
    {
        public static List<CarData> carData = new List<CarData>
        {
            new CarData { Car = "subaru", Year = 2008, Color = "black" },
            new CarData { Car = "toyota", Year = 2010, Color = "red" }
        };
        ...
        public ActionResult ExcelExport([FromForm] string gridModel)
        {
            ...
            return exp.ExcelExport<CarData>(gridProperty, carData);
        }
        public ActionResult PdfExport([FromForm] string gridModel)
        {
            GridPdfExport exp = new GridPdfExport();
            Grid gridProperty = ConvertGridObject(gridModel);
            return exp.PdfExport<CarData>(gridProperty, orddata);
        }
